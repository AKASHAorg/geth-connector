...
const gethVersion = 'v1.5.6/';
const unlinkAsync = Promise.promisify(unlink);
// const baseUrl = url.resolve(repo, gethVersion);

const source = {
    linux: repo + 'geth-linux-amd64-1.5.6-2a609af5.tar.gz',
    win: repo + 'geth-windows-amd64-1.5.6-2a609af5.zip',
    osx: repo + 'geth-darwin-amd64-1.5.6-2a609af5.tar.gz'
};
