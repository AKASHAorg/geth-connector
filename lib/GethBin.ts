...
const gethVersion = 'v1.5.7/';
const unlinkAsync = Promise.promisify(unlink);
// const baseUrl = url.resolve(repo, gethVersion);

const source = {
    linux: repo + 'geth-linux-amd64-1.5.7-da2a22c3.tar.gz',
    win: repo + 'geth-windows-amd64-1.5.7-da2a22c3.zip',
    osx: repo + 'geth-darwin-amd64-1.5.7-da2a22c3.tar.gz'
};
